...
with sync_playwright() as playwright:
    ...
    courses_title = page.locator('//div/h6[@data-testid="courses-list-toolbar-title-text"]')
    ...
    empty_view_title_text = page.locator('//h6[@data-testid="courses-list-empty-view-title-text"]')
    expect(empty_view_title_text).to_be_visible()
    expect(empty_view_title_text).to_have_text("There is no results")

    empty_view_description_text = page.locator('//p[@data-testid="courses-list-empty-view-description-text"]')
